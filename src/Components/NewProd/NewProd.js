...
class NewProd extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <input id="quantity" type="text" name="quantity" placeholder="Product Quantity:" value={this.props.newQuantity} onChange={this.props.handleInputChange} />
            <input id="price" type="text" name="price" placeholder="Product Price:" value={this.props.newPrice} onChange={this.props.handleInputChange} />
